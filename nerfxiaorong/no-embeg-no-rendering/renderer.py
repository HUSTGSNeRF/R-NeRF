...
class Renderer_RSSI(Renderer):
    ...
    def render_rssi(self, tx, rays_o, rays_d, ris ,rays_o1,rays_d1):
        ...
        recv_signal1 = torch.zeros(batchsize1).cuda() # tx ris
        recv_signal2 = torch.zeros(batchsize1).cuda() # tx ris
        ...
        for i in range(chunks_num):
            ...
            recv_signal_chunks1 = self.raw2outputs_signal(raw, t_vals1, rays_d_chunk1)  # [bs]
            recv_signal_chunks2 = self.raw2outputs_signal(raw1, t_vals, rays_d_chunk)  # [bs]
            
            recv_signal1 += recv_signal_chunks1
            recv_signal2 += recv_signal_chunks2


        return recv_signal1, recv_signal2    # [batchsize,]
